...
var _loovjo$traffic$Main$subscriptions = function (model) {
	return _elm_lang$websocket$WebSocket$keepAlive(model.webSocketUrl);
};
				...
				_1: _elm_lang$core$Platform_Cmd$batch(
					{
						...
						_0: A2(
							...
							model.webSocketUrl,
							A2(_elm_lang$core$Basics_ops['++'], 'login/', model.name)),
						_1: {
							ctor: '::',
							_0: _elm_lang$navigation$Navigation$load('traffic.html'),
							_1: {ctor: '[]'}
						}
					})
			};
...
var _loovjo$traffic$Main$init = function (flags) {
	return {
		ctor: '_Tuple2',
		_0: {webSocketUrl: flags.webSocketUrl, name: ''},
		_1: _elm_lang$core$Platform_Cmd$none
	};
};
...
var _loovjo$traffic$Main$Model = F2(
	function (a, b) {
		return {name: a, webSocketUrl: b};
	});
var _loovjo$traffic$Main$Submit = {ctor: 'Submit'};
var _loovjo$traffic$Main$ChangeName = function (a) {
		...
		},
		{
			...
			_1: {
				...
				_0: A2(
					...
					{
						ctor: '::',
						_0: _elm_lang$html$Html_Events$onSubmit(_loovjo$traffic$Main$Submit),
						_1: {ctor: '[]'}
					},
					{
						ctor: '::',
