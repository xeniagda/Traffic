...
var _loovjo$traffic$Main$decodePosition = A3(
	_elm_lang$core$Json_Decode$map2,
	F2(
		function (x, y) {
			return {x: x, y: y};
...
var _loovjo$traffic$Main$getTrafficLightPath = function (light) {
...
var _loovjo$traffic$Main$getImg = function (car) {
	return A2(
		_elm_lang$core$Basics_ops['++'],
		car.crashed ? A2(_elm_lang$core$Basics_ops['++'], car.img, 'Trasig') : car.img,
		'.png');
};
var _loovjo$traffic$Main$carHeight = 0.8;
var _loovjo$traffic$Main$carWidth = _loovjo$traffic$Main$carHeight * 2;
var _loovjo$traffic$Main_ops = _loovjo$traffic$Main_ops || {};
_loovjo$traffic$Main_ops['!!'] = F2(
	function (lst, n) {
				...
				_0: A2(
					_elm_lang$svg$Svg$svg,
					{
						...
						_1: {
							...
							_1: {
								ctor: '::',
								_0: _elm_lang$svg$Svg_Attributes$style('background: #004400'),
								_1: {ctor: '[]'}
							}
						}
					},
					function () {
						var trafficLights = A2(
															...
															_1: {
																...
																_1: {
																	...
																	_0: _elm_lang$svg$Svg_Attributes$xlinkHref(
																		_loovjo$traffic$Main$getTrafficLightPath(_p3)),
																	_1: {ctor: '[]'}
																}
															}
														}
							...
							function (car) {
								return A2(
									_elm_lang$svg$Svg$image,
									{
										ctor: '::',
										_0: _elm_lang$svg$Svg_Attributes$x(
											_elm_lang$core$Basics$toString((model.scroll.x + (car.pos.x * model.renderScale)) - ((_loovjo$traffic$Main$carWidth / 2) * model.renderScale))),
										_1: {
											ctor: '::',
											_0: _elm_lang$svg$Svg_Attributes$y(
												_elm_lang$core$Basics$toString((model.scroll.y + (car.pos.y * model.renderScale)) - ((_loovjo$traffic$Main$carHeight / 2) * model.renderScale))),
											_1: {
												ctor: '::',
												_0: _elm_lang$svg$Svg_Attributes$width(
													_elm_lang$core$Basics$toString(_loovjo$traffic$Main$carWidth * model.renderScale)),
												_1: {
													ctor: '::',
													_0: _elm_lang$svg$Svg_Attributes$height(
														_elm_lang$core$Basics$toString(_loovjo$traffic$Main$carHeight * model.renderScale)),
													_1: {
														ctor: '::',
														_0: _elm_lang$svg$Svg_Attributes$xlinkHref(
															A2(
																_elm_lang$core$Basics_ops['++'],
																'Textures/Cars/',
																_loovjo$traffic$Main$getImg(car))),
														_1: {
															ctor: '::',
						...
						var roadCaps = A2(
							...
							function (road) {
								return A2(
									_elm_lang$core$List$concatMap,
									function (idx) {
										var maybeOtherRoad = A2(_loovjo$traffic$Main_ops['!!'], model.roads, idx);
										var _p5 = maybeOtherRoad;
										if (_p5.ctor === 'Just') {
											var _p6 = _p5._0;
											var otherRoadRot = _elm_lang$core$Tuple$second(
												_elm_lang$core$Basics$toPolar(
													{ctor: '_Tuple2', _0: _p6.end.x - _p6.start.x, _1: _p6.end.y - _p6.start.y}));
											var otherRoadEdge1x = ((_p6.start.x + _elm_lang$core$Tuple$first(
												_elm_lang$core$Basics$fromPolar(
													{ctor: '_Tuple2', _0: _p6.width / 2, _1: otherRoadRot - (_elm_lang$core$Basics$pi / 2)}))) * model.renderScale) + model.scroll.x;
											var otherRoadEdge1y = ((_p6.start.y + _elm_lang$core$Tuple$second(
												_elm_lang$core$Basics$fromPolar(
													{ctor: '_Tuple2', _0: _p6.width / 2, _1: otherRoadRot - (_elm_lang$core$Basics$pi / 2)}))) * model.renderScale) + model.scroll.y;
											var otherRoadEdge2x = ((_p6.start.x - _elm_lang$core$Tuple$first(
												_elm_lang$core$Basics$fromPolar(
													{ctor: '_Tuple2', _0: _p6.width / 2, _1: otherRoadRot - (_elm_lang$core$Basics$pi / 2)}))) * model.renderScale) + model.scroll.x;
											var otherRoadEdge2y = ((_p6.start.y - _elm_lang$core$Tuple$second(
												_elm_lang$core$Basics$fromPolar(
													{ctor: '_Tuple2', _0: _p6.width / 2, _1: otherRoadRot - (_elm_lang$core$Basics$pi / 2)}))) * model.renderScale) + model.scroll.y;
								...
								return A2(
									...
									A2(
										...
										A2(
											_elm_lang$core$List$range,
											0,
											_elm_lang$core$Basics$floor(_p8.x / model.renderScale))),
									A2(
										_elm_lang$core$List$map,
										function (y) {
											return A2(
										...
										A2(
											_elm_lang$core$List$range,
											0,
											_elm_lang$core$Basics$floor(_p8.y / model.renderScale))));
							} else {
								return {ctor: '[]'};
							}
						}();
							...
							A2(
								...
								A2(
									...
									A2(
										_elm_lang$core$Basics_ops['++'],
										roadLines,
										A2(_elm_lang$core$Basics_ops['++'], cars, trafficLights)))));
					}()),
				_1: {ctor: '[]'}
			},
			{
...
var _loovjo$traffic$Main$pAdd = F2(
	function (p1, p2) {
		return {x: p1.x + p2.x, y: p1.y + p2.y};
	});
var _loovjo$traffic$Main$zoomFactor = 1.2;
var _loovjo$traffic$Main$Controls = function (a) {
	return function (b) {
		return function (c) {
			return function (d) {
				return function (e) {
					return function (f) {
						return function (g) {
							return function (h) {
								return function (i) {
									return function (j) {
										return {up: a, left: b, right: c, $break: d, back: e, carUp: f, carDown: g, carFree: h, zoomIn: i, zoomOut: j};
									};
								};
							};
						};
...
var _loovjo$traffic$Main$Position = F2(
	function (a, b) {
		return {x: a, y: b};
	});
var _loovjo$traffic$Main$Car = function (a) {
	return function (b) {
		return function (c) {
			return function (d) {
				return function (e) {
...
var _loovjo$traffic$Main$decodeCars = _elm_lang$core$Json_Decode$list(
	A2(
		_NoRedInk$elm_decode_pipeline$Json_Decode_Pipeline$custom,
								...
								A3(
									...
									A3(
										...
										A3(
											_NoRedInk$elm_decode_pipeline$Json_Decode_Pipeline$required,
											'pos',
											_loovjo$traffic$Main$decodePosition,
											A3(
												_NoRedInk$elm_decode_pipeline$Json_Decode_Pipeline$required,
												'img',
												_elm_lang$core$Json_Decode$string,
												A3(
													...
													'name',
													_elm_lang$core$Json_Decode$string,
													_NoRedInk$elm_decode_pipeline$Json_Decode_Pipeline$decode(_loovjo$traffic$Main$Car))))))))))))));
var _loovjo$traffic$Main$TrafficLight = F2(
	function (a, b) {
		return {greenLeft: a, offset: b};
	});
var _loovjo$traffic$Main$decodeTrafficLight = A3(
	_NoRedInk$elm_decode_pipeline$Json_Decode_Pipeline$required,
	'offset',
	_loovjo$traffic$Main$decodePosition,
	A3(
		...
		'green_left',
		_elm_lang$core$Json_Decode$float,
		_NoRedInk$elm_decode_pipeline$Json_Decode_Pipeline$decode(_loovjo$traffic$Main$TrafficLight)));
var _loovjo$traffic$Main$Road = F5(
	function (a, b, c, d, e) {
		return {start: a, end: b, connectedTo: c, trafficLight: d, width: e};
	});
var _loovjo$traffic$Main$decodeRoads = _elm_lang$core$Json_Decode$list(
	A4(
		_NoRedInk$elm_decode_pipeline$Json_Decode_Pipeline$optional,
		'width',
		_elm_lang$core$Json_Decode$float,
		...
		A2(
			_NoRedInk$elm_decode_pipeline$Json_Decode_Pipeline$custom,
			_elm_lang$core$Json_Decode$maybe(
				A2(_elm_lang$core$Json_Decode$field, 'traffic_light', _loovjo$traffic$Main$decodeTrafficLight)),
			A3(
				_NoRedInk$elm_decode_pipeline$Json_Decode_Pipeline$required,
				'connected_to',
				...
				A3(
					...
					A3(
						...
						'start',
						_loovjo$traffic$Main$decodePosition,
						_NoRedInk$elm_decode_pipeline$Json_Decode_Pipeline$decode(_loovjo$traffic$Main$Road)))))));
var _loovjo$traffic$Main$Traffic = F3(
	function (a, b, c) {
		return {cars: a, roads: b, ip: c};
	});
var _loovjo$traffic$Main$decodeTraffic = A3(
	_NoRedInk$elm_decode_pipeline$Json_Decode_Pipeline$required,
	'ip',
	_elm_lang$core$Json_Decode$string,
	A3(
		_NoRedInk$elm_decode_pipeline$Json_Decode_Pipeline$required,
		'roads',
		_loovjo$traffic$Main$decodeRoads,
		A3(
			_NoRedInk$elm_decode_pipeline$Json_Decode_Pipeline$required,
			'cars',
			_loovjo$traffic$Main$decodeCars,
			_NoRedInk$elm_decode_pipeline$Json_Decode_Pipeline$decode(_loovjo$traffic$Main$Traffic))));
var _loovjo$traffic$Main$Model = function (a) {
	return function (b) {
		return function (c) {
			return function (d) {
				return function (e) {
												...
												return function (m) {
													return function (n) {
														return function (o) {
															return function (p) {
																return function (q) {
																	return {cars: a, roads: b, err: c, size: d, lasttime: e, scroll: f, lastMouse: g, renderScale: h, webSocketUrl: i, msg: j, ip: k, accelRate: l, steerRate: m, lastClickTime: n, trackingCar: o, controls: p, isPolis: q};
																};
															};
														};
													};
...
var _loovjo$traffic$Main$SendWebSocketMsg = {ctor: 'SendWebSocketMsg'};
var _loovjo$traffic$Main$SetMsg = function (a) {
	return {ctor: 'SetMsg', _0: a};
};
var _loovjo$traffic$Main$KeyUp = function (a) {
	return {ctor: 'KeyUp', _0: a};
};
var _loovjo$traffic$Main$KeyDown = function (a) {
	return {ctor: 'KeyDown', _0: a};
};
var _loovjo$traffic$Main$MouseMove = function (a) {
	return {ctor: 'MouseMove', _0: a};
};
var _loovjo$traffic$Main$MouseRelease = function (a) {
...
var _loovjo$traffic$Main$CheckSize = {ctor: 'CheckSize'};
var _loovjo$traffic$Main$init = function (flags) {
	return {
		ctor: '_Tuple2',
		_0: _loovjo$traffic$Main$Model(
			{ctor: '[]'})(
			...
			A2(_elm_lang$core$Debug$log, 'is rubs', flags.isRubs)),
		_1: A2(
			_elm_lang$core$Task$perform,
			_elm_lang$core$Basics$identity,
			_elm_lang$core$Task$succeed(_loovjo$traffic$Main$CheckSize))
	};
};
var _loovjo$traffic$Main$Resize = function (a) {
...
var _loovjo$traffic$Main$update = F2(
	function (msg, model) {
		...
		switch (_p11.ctor) {
			case 'ServerSync':
				var result = A2(_elm_lang$core$Json_Decode$decodeString, _loovjo$traffic$Main$decodeTraffic, _p11._0);
				var _p12 = result;
				if (_p12.ctor === 'Ok') {
					var _p13 = _p12._0;
					return {
					...
					return {
						...
						_0: _elm_lang$core$Native_Utils.update(
							model,
							{
								err: _elm_lang$core$Maybe$Just(_p12._0)
							}),
					...
					_0: _elm_lang$core$Native_Utils.update(
						model,
						{
							size: _elm_lang$core$Maybe$Just(
								{
									x: _elm_lang$core$Basics$toFloat(_p14.width),
									y: _elm_lang$core$Basics$toFloat(_p14.height)
								})
						}),
					_1: _elm_lang$core$Platform_Cmd$none
				};
			...
			case 'MousePress':
				var _p26 = _p11._0;
				var _p24 = model.lasttime;
				if (_p24.ctor === 'Just') {
					var _p25 = model.lastClickTime;
					if (_p25.ctor === 'Just') {
						if (_elm_lang$core$Native_Utils.cmp(_p24._0 - _p25._0, 500) > 0) {
							return {
								ctor: '_Tuple2',
								_0: _elm_lang$core$Native_Utils.update(
									model,
									{
										lastMouse: _elm_lang$core$Maybe$Just(
											{
												x: _elm_lang$core$Basics$toFloat(_p26.x),
												y: _elm_lang$core$Basics$toFloat(_p26.y)
											})
									}),
								_1: _elm_lang$core$Platform_Cmd$none
							};
						} else {
							var y = (_elm_lang$core$Basics$toFloat(_p26.y) - model.scroll.y) / model.renderScale;
							var x = (_elm_lang$core$Basics$toFloat(_p26.x) - model.scroll.x) / model.renderScale;
							return {
								ctor: '_Tuple2',
								_0: model,
								_1: A2(
			...
			case 'MouseMove':
						...
						return _elm_lang$core$Native_Utils.eq(
							_elm_lang$core$List$length(
								A2(
									_elm_lang$core$List$filter,
									function (car) {
										return _elm_lang$core$Native_Utils.eq(car.name, _p27._0);
									},
									model.cars)),
							0);
					}
				...
				if (track) {
					var _p28 = model.lastMouse;
					if (_p28.ctor === 'Just') {
						var _p29 = _p28._0;
						var delta = {
							x: _elm_lang$core$Basics$toFloat(_p30.x) - _p29.x,
							y: _elm_lang$core$Basics$toFloat(_p30.y) - _p29.y
						};
						return {
							ctor: '_Tuple2',
							_0: _elm_lang$core$Native_Utils.update(
			...
			case 'KeyDown':
				...
				if (_p31.ctor === 'Just') {
					var _p49 = _p31._0;
					return _elm_lang$core$Native_Utils.eq(_p50, model.controls.zoomIn) ? {
						ctor: '_Tuple2',
						_0: _elm_lang$core$Native_Utils.update(
							model,
							{
						...
						_1: _elm_lang$core$Platform_Cmd$none
					} : (_elm_lang$core$Native_Utils.eq(_p50, model.controls.zoomOut) ? {
						ctor: '_Tuple2',
						_0: _elm_lang$core$Native_Utils.update(
							model,
							{
						...
						_1: _elm_lang$core$Platform_Cmd$none
					} : (_elm_lang$core$Native_Utils.eq(_p50, model.controls.$break) ? {
						ctor: '_Tuple2',
						_0: _elm_lang$core$Native_Utils.update(
							model,
							{
					...
					} : (_elm_lang$core$Native_Utils.eq(_p50, model.controls.up) ? {
						ctor: '_Tuple2',
						_0: _elm_lang$core$Native_Utils.update(
							model,
							{
					...
					} : (_elm_lang$core$Native_Utils.eq(_p50, model.controls.back) ? {
						ctor: '_Tuple2',
						_0: _elm_lang$core$Native_Utils.update(
							model,
							{
					...
					} : (_elm_lang$core$Native_Utils.eq(_p50, model.controls.left) ? {
						ctor: '_Tuple2',
						_0: _elm_lang$core$Native_Utils.update(
							model,
							{
					...
					} : (_elm_lang$core$Native_Utils.eq(_p50, model.controls.right) ? {
						ctor: '_Tuple2',
						_0: _elm_lang$core$Native_Utils.update(
							model,
							{
					...
					} : (_elm_lang$core$Native_Utils.eq(_p50, model.controls.carFree) ? {
						ctor: '_Tuple2',
						_0: _elm_lang$core$Native_Utils.update(
							model,
							{trackingCar: _elm_lang$core$Maybe$Nothing}),
						_1: _elm_lang$core$Platform_Cmd$none
					} : ((_elm_lang$core$Native_Utils.eq(_p50, model.controls.carUp) || _elm_lang$core$Native_Utils.eq(_p50, model.controls.carDown)) ? {
						ctor: '_Tuple2',
						_0: _elm_lang$core$Native_Utils.update(
							model,
							{
								trackingCar: function () {
									...
									if (_p43.ctor === 'Nothing') {
										...
										if (_p46.ctor === 'Just') {
											var _p48 = _p46._0._0;
											var res = _elm_lang$core$Native_Utils.eq(_p50, model.controls.carUp) ? A2(
												_elm_lang$core$Maybe$map,
												function (_) {
													return _.name;
												},
											...
											if (_p47.ctor === 'Just') {
												...
												return _elm_lang$core$Native_Utils.eq(_p50, model.controls.carUp) ? A2(
													_elm_lang$core$Maybe$map,
													function (_) {
														return _.name;
													},
			...
			case 'KeyUp':
				...
				if (_p51.ctor === 'Just') {
					var _p55 = _p51._0;
					return _elm_lang$core$Native_Utils.eq(_p56, model.controls.$break) ? {
						ctor: '_Tuple2',
						_0: _elm_lang$core$Native_Utils.update(
							model,
							{
					...
					} : ((_elm_lang$core$Native_Utils.eq(_p56, model.controls.up) || _elm_lang$core$Native_Utils.eq(_p56, model.controls.back)) ? {
						ctor: '_Tuple2',
						_0: _elm_lang$core$Native_Utils.update(
							model,
							{
					...
					} : ((_elm_lang$core$Native_Utils.eq(_p56, model.controls.left) || _elm_lang$core$Native_Utils.eq(_p56, model.controls.right)) ? {
						ctor: '_Tuple2',
						_0: _elm_lang$core$Native_Utils.update(
							model,
							{
...
var _loovjo$traffic$Main$ServerSync = function (a) {
...
var _loovjo$traffic$Main$subscriptions = function (model) {
	return _elm_lang$core$Platform_Sub$batch(
		{
			ctor: '::',
			_0: _elm_lang$window$Window$resizes(_loovjo$traffic$Main$Resize),
			_1: {
				ctor: '::',
				_0: A2(_elm_lang$core$Time$every, _elm_lang$core$Time$second / 30, _loovjo$traffic$Main$UpdateClient),
				_1: {
					ctor: '::',
					_0: _elm_lang$mouse$Mouse$downs(_loovjo$traffic$Main$MousePress),
					_1: {
						ctor: '::',
						_0: _elm_lang$mouse$Mouse$ups(_loovjo$traffic$Main$MouseRelease),
						_1: {
							ctor: '::',
							_0: _elm_lang$mouse$Mouse$moves(_loovjo$traffic$Main$MouseMove),
							_1: {
								ctor: '::',
								_0: _elm_lang$keyboard$Keyboard$downs(_loovjo$traffic$Main$KeyDown),
								_1: {
									ctor: '::',
									_0: _elm_lang$keyboard$Keyboard$ups(_loovjo$traffic$Main$KeyUp),
									_1: {
										ctor: '::',
										_0: A2(_elm_lang$websocket$WebSocket$listen, model.webSocketUrl, _loovjo$traffic$Main$ServerSync),
										_1: {ctor: '[]'}
									}
								}
							}
																			...
																			return A2(
																				...
																				function (zoomIn) {
																					return A2(
																						...
																						function (zoomOut) {
																							return _elm_lang$core$Json_Decode$succeed(
																								{back: back, $break: $break, carDown: carDown, carFree: carFree, carUp: carUp, left: left, right: right, up: up, zoomIn: zoomIn, zoomOut: zoomOut});
																						},
