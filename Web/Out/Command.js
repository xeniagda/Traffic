...
var _loovjo$traffic$Command$Flags = function (a) {
	return {webSocketUrl: a};
};
var _loovjo$traffic$Command$Resp = F2(
	function (a, b) {
		return {res: a, perms: b};
	});
var _loovjo$traffic$Command$decodeResp = A2(
	_NoRedInk$elm_decode_pipeline$Json_Decode_Pipeline$custom,
	...
	A2(
		_NoRedInk$elm_decode_pipeline$Json_Decode_Pipeline$custom,
		_elm_lang$core$Json_Decode$maybe(
			A2(_elm_lang$core$Json_Decode$field, 'res', _elm_lang$core$Json_Decode$string)),
		_NoRedInk$elm_decode_pipeline$Json_Decode_Pipeline$decode(_loovjo$traffic$Command$Resp)));
var _loovjo$traffic$Command$update = F2(
	function (msg, model) {
		var _p0 = msg;
		switch (_p0.ctor) {
			case 'ServerMsg':
				var result = A2(_elm_lang$core$Json_Decode$decodeString, _loovjo$traffic$Command$decodeResp, _p0._0);
				var _p1 = result;
				if (_p1.ctor === 'Ok') {
					var _p3 = _p1._0;
					return {
			...
			case 'SendCommand':
				return {
					...
					_1: A2(
						...
						model.webSocketUrl,
						A2(_elm_lang$core$Basics_ops['++'], 'cmd/', model.currentCommand))
				};
			case 'SendWSCommand':
				return {
					ctor: '_Tuple2',
					_0: _elm_lang$core$Native_Utils.update(
						model,
						{currentCommand: ''}),
					_1: A2(_elm_lang$websocket$WebSocket$send, model.webSocketUrl, model.currentCommand)
				};
			case 'UpdateText':
				return {
					ctor: '_Tuple2',
			...
			default:
				return {
					...
					_0: A2(
						_elm_lang$core$Basics$always,
						model,
						A2(_elm_lang$core$Debug$log, 'Key', _p0._0)),
					_1: _elm_lang$core$Platform_Cmd$none
				};
		}
	});
var _loovjo$traffic$Command$Model = F4(
	function (a, b, c, d) {
		return {currentCommand: a, webSocketUrl: b, resp: c, perms: d};
	});
var _loovjo$traffic$Command$init = function (flags) {
	return {
		ctor: '_Tuple2',
		_0: A4(
			_loovjo$traffic$Command$Model,
			'',
			flags.webSocketUrl,
			{ctor: '[]'},
			_elm_lang$core$Maybe$Nothing),
...
var _loovjo$traffic$Command$UpdateText = function (a) {
	return {ctor: 'UpdateText', _0: a};
};
var _loovjo$traffic$Command$KeyPressed = function (a) {
	return {ctor: 'KeyPressed', _0: a};
};
var _loovjo$traffic$Command$SendWSCommand = {ctor: 'SendWSCommand'};
var _loovjo$traffic$Command$SendCommand = {ctor: 'SendCommand'};
var _loovjo$traffic$Command$view = function (model) {
	var _p4 = model.perms;
	if (_p4.ctor === 'Nothing') {
		return A2(
			...
			{
				ctor: '::',
				_0: _elm_lang$html$Html$text('Connecting...'),
				_1: {ctor: '[]'}
			});
	} else {
		return A2(_elm_lang$core$List$member, 'command', _p4._0) ? A2(
			...
			A2(
						...
						return A2(
							...
							{ctor: '[]'},
							{
								...
								_0: A2(
									...
									{
										ctor: '::',
										_0: _elm_lang$html$Html$text(resp),
										_1: {ctor: '[]'}
									}),
								_1: {
									ctor: '::',
					...
					model.resp),
				{
					...
					_0: A2(
						...
						{
							ctor: '::',
							_0: _elm_lang$html$Html_Events$onSubmit(_loovjo$traffic$Command$SendCommand),
							_1: {ctor: '[]'}
						},
						{
							ctor: '::',
							_0: A2(
								...
								{
									ctor: '::',
									_0: _elm_lang$html$Html_Events$onInput(_loovjo$traffic$Command$UpdateText),
									_1: {
										ctor: '::',
								...
								{
									ctor: '::',
									_0: _elm_lang$html$Html$text(model.currentCommand),
									_1: {ctor: '[]'}
								}),
							_1: {
								ctor: '::',
					...
					_1: {
						...
						_0: A2(
							...
							{
								ctor: '::',
								_0: _elm_lang$html$Html_Events$onClick(_loovjo$traffic$Command$SendWSCommand),
								_1: {ctor: '[]'}
							},
							{
								ctor: '::',
								_0: _elm_lang$html$Html$text('Send as WebSocket command'),
								_1: {ctor: '[]'}
							}),
						_1: {ctor: '[]'}
					}
			...
			{
				ctor: '::',
				_0: _elm_lang$html$Html$text('You do not have access to moderator commands.'),
				_1: {ctor: '[]'}
			});
	}
};
var _loovjo$traffic$Command$ServerMsg = function (a) {
	return {ctor: 'ServerMsg', _0: a};
};
var _loovjo$traffic$Command$subscriptions = function (model) {
	return A2(_elm_lang$websocket$WebSocket$listen, model.webSocketUrl, _loovjo$traffic$Command$ServerMsg);
};
var _loovjo$traffic$Command$main = _elm_lang$html$Html$programWithFlags(
	{init: _loovjo$traffic$Command$init, view: _loovjo$traffic$Command$view, update: _loovjo$traffic$Command$update, subscriptions: _loovjo$traffic$Command$subscriptions})(
	A2(
		_elm_lang$core$Json_Decode$andThen,
...
if (typeof _loovjo$traffic$Command$main !== 'undefined') {
    _loovjo$traffic$Command$main(Elm['Command'], 'Command', undefined);
}
